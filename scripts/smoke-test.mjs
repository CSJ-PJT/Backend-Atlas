...
assert(dom.window.document.querySelectorAll('.concept-accordion').length>=7,'concept detail must use compact accordions');
assert(dom.window.document.querySelector('.learning-visual svg'),'concept detail must render a learning diagram');
...
assert(dom.window.document.querySelectorAll('.learning-visual svg').length>=2,'project guide must render architecture and sequence diagrams');
